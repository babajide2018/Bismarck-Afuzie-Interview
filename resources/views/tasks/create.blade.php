<x-app-layout>
    <div style="width: 480px;"class="max-w-full mx-auto mt-10 px-4 py-8 text-gray-500">
        ...
        <form action="{{route('tasks.store')}}" method="POST">
            ...
            <label class="block" for="project_name">Choose Project: </label>
            <select  class="w-full mb-2 rounded-lg bg-gray-200" name="project_name">
            ...
            @error('task_details')
                <p class="text-base pb-4 text-red-400">{{$message}}</p>
            @enderror
            <label class="block" for="task_name">Priority: </label>
            <select  class="w-full mb-2 rounded-lg bg-gray-200" name="priority">
