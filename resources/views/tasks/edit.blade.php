<x-app-layout>
    <div style="width: 480px;"class="max-w-full mx-auto mt-10 px-4 py-8 text-gray-500">
        ...
        <form action="{{route('tasks.update', $task->id)}}" method="POST">
            ...
            <label class="block" for="project_name">Project Name: </label>
            <input class="w-full mb-2 rounded-lg bg-gray-200" type="text" name="project_name" value="{{$task->project_name}}">
            @error('project_name')
